...
export const TrackListWrapper = () => {
  ...
  const visibleTracks = useMemo(() => {
    ...
    const tracksToFormat =
      trackList.data.items.length <= TRACKS_LENGTH_COLLAPSED || showMore.isOpen
  ...
  return (
    <>
      <TrackList
        ...
        columns={['play', 'avatar', 'name', 'album', 'liked', 'duration']}
        fromPlaylist={false}
        items={visibleTracks}
      />
      ...
      <Button onPress={showMore.isOpen ? showMore.onClose : showMore.onOpen} variant="ghost">
