      ...
      <div className="">
        <div className="flex flex-wrap gap-2 mt-2 items-center overflow-x-scroll scrollbar-hide">
          {selectedChips.length > 0 && (
            ...
            >
              <Image src="/icons/close.svg" alt="clear filters" width={20} height={20} />
            </Button>
          )}
        ...
        <Select className="max-w-xs">
          <SelectSection showDivider title="Sort by">
            <SelectItem textValue={'Recents'}>Recents</SelectItem>
            <SelectItem textValue={'Recently added'}>Recently added</SelectItem>
            <SelectItem textValue={'Alphabetical'}>Alphabetical</SelectItem>
            <SelectItem textValue={'Creator'}>Creator</SelectItem>
          </SelectSection>
        ...
        <div className="flex mt-2">
          ...
          <Button isIconOnly onPress={() => setInputTouched((prev) => !prev)}>
            <Image src="/icons/search.svg" width={20} height={20} alt="search in library" />
          </Button>
        </div>
      </div>
    </div>
