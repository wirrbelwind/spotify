  ...
  return (
    <Dropdown>
      ...
      <DropdownMenu aria-label="Account actions">
        <DropdownItem key="account" href={user.data?.external_urls.spotify} target="_blank">
          Account
        </DropdownItem>
        <DropdownItem key="profile" href={routeUrl.profile()} as={Link}>
          Profile
        </DropdownItem>
        <DropdownItem key="settings" href={routeUrl.settings()} as={Link}>
          Settings
        </DropdownItem>
        <DropdownItem key="log-out" href="/api/auth/logout" as={Link}>
          Log out
        </DropdownItem>
      </DropdownMenu>
    </Dropdown>
