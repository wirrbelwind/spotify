...
export const MediaCard = ({
  ...
  return (
    <Link href={url ?? '#'} className="hover:bg-slate-400 p-2 group rounded-md relative block">
      <div className="relative overflow-hidden">
        ...
        {playbackUri && <StartPlaybackButton uri={playbackUri} showOnHover />}
      </div>

      <p className="mt-3 truncate">{typeof title === 'string' ? title : title()}</p>
