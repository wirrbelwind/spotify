  ...
  return (
    <div {...elementsProps?.wrapper}>
      <Button
        ...
        className=""
      >
        <Image src="/icons/shuffle.svg" alt="Shuffle playback" width={35} height={35} />
      </Button>
      ...
      >
        {!player.data || player.data?.paused ? (
          <Image src="/icons/play.svg" alt="Play" width={35} height={35} />
        ) : (
          <Image src="/icons/pause.svg" alt="" width={35} height={35} className="Pause" />
        )}
      </Button>
      <Button
